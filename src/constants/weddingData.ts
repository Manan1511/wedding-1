...
export const WEDDING_EVENTS: WeddingEvent[] = [
  ...
  },
  {
    ...
    attireColors: [
      ...
      { name: 'Bright Mustard', hex: '#EAB308' },
      { name: 'Pearl White', hex: '#FFFFFF' },
      { name: 'Soft Cream', hex: '#F7EEDD' },
    ],
    venueName:   VENUE_NAME,
    iconName:    'haldi',
  },
  {
    ...
    attireColors: [
      { name: 'Royal Maroon', hex: '#6B2737' },
      { name: 'Crimson Red', hex: '#9E1B32' },
      { name: 'Antique Gold', hex: '#C4A265' },
      { name: 'Deep Wine', hex: '#4A1521' },
    ],
    venueName:   VENUE_NAME,
    iconName:    'baraat',
  },
  {
    ...
    attireColors: [
      { name: 'Saffron Orange', hex: '#E65100' },
      { name: 'Nauvari Green', hex: '#1B5E20' },
      { name: 'Zari Gold', hex: '#D4AF37' },
      { name: 'Auspicious Red', hex: '#B71C1C' },
    ],
    venueName:   VENUE_NAME,
    iconName:    'varmala',
  },
  {
    ...
    attireColors: [
      { name: 'Paithani Purple', hex: '#581C87' },
      { name: 'Peacock Blue', hex: '#0E7490' },
      { name: 'Silk Gold', hex: '#D4AF37' },
      { name: 'Ruby Magenta', hex: '#BE185D' },
    ],
    venueName:   VENUE_NAME,
    iconName:    'pheras',
  },
  {
    ...
    attireColors: [
      { name: 'Royal Burgundy', hex: '#4D1B27' },
      { name: 'Champagne Gold', hex: '#E5C178' },
      { name: 'Dusty Rose', hex: '#DBA39A' },
      { name: 'Midnight Plum', hex: '#2A1B30' },
    ],
    venueName:   VENUE_NAME,
    iconName:    'bidai',
  },
