...
export const WEDDING_EVENTS: WeddingEvent[] = [
  ...
  },
  {
    ...
    description: "The most fun you'll have getting messy. Wear something you don't mind turning golden — because the haldi will find you.",
  ...
  },
  {
    ...
    description: 'The groom arrives. Dhol, dancing, and the whole family riding in together — come join the procession.',
